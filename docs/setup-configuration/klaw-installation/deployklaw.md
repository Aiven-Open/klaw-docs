...
to deliver new updates approximately every 1.5 months. You can access all past and the most recent releases [here](../../../docs/releases). Highlighted updates include versions such as 2.4.0, 2.5.0, among others.
