...
1. Access Klaw using the below default credentials for the superadmin
   ...
   - **Password:** Set based on the KLAW_SUPERADMIN_DEFAULT_PASSWORD property defined in docker compose file. From Klaw 2.10.0 we are enforcing users to set their own superadmin password by setting KLAW_SUPERADMIN_DEFAULT_PASSWORD in the docker yaml file
