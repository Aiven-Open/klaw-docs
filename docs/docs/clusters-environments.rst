...
The Klaw concept of Cluster maps neatly to your Apache Kakfa clusters; a "cluster" in Klaw is an Apache Kafka server or cluster. Add the clusters you want Klaw to work with.
