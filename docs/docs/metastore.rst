...
Scripts are included in the source code repository to create the database structure and insert some starter data. YYou will find these in the `scripts/base/rdbms/` directory.
