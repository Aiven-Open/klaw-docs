# -*- coding: utf-8 -*-
#
# Klaw documentation build configuration file, created by
...
html_css_files = ['css/aiven.min.css','css/klaw.css']
...
latex_documents = [
  ('index', 'ReadtheDocsTemplate.tex', u'Kafkawize Documentation',
...
man_pages = [
    ('index', 'readthedocstemplate', u'Klaw Documentation',
     [u'Read the Docs'], 1)
]
